...
import { employeesData, role } from "@/lib/data";  // Ensure the data is correctly imported
...
type Employee = {  
  ...
  name: string;
  email?: string;
  employees: string[];  // Should be 'employees', not 'students'
  phone: string;
  address: string;
};
...
const columns = [
  ...
  { header: "Employee Names", accessor: "employees", className: "hidden md:table-cell" },
